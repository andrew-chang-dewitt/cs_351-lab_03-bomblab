...
0000000000401036 <phase_2>:
  401036:	55                   	push   %rbp
  401037:	53                   	push   %rbx
  # make room for a 6 item array  of ints & 1 more int on stack (6 * 4) + 4 = 28
  401038:	48 83 ec 28          	sub    $0x28,%rsp
  40103c:	48 89 e6             	mov    %rsp,%rsi
  # read 6 items & the length? from rdi (user input str) into array at $rsp
  40103f:	e8 f1 03 00 00       	callq  401435 <read_six_numbers>
  # check that length is right by subtracting 0 from stack pointer
  401044:	83 3c 24 00          	cmpl   $0x0,(%rsp)
  # if result was negative, then length of input array was wrong
...
0000000000401145 <phase_3>:
  # make room for 18 bytes on stack
